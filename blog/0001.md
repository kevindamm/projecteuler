...
<div class="numbers-grid">
  <div class="numbers-plus"> +? </div>
  <div class="numbers-cell" v-for="index in 1">?</div>
</div>
...
this way anyway, I've left it as two separate for-loops.  You could reorganize
it to operate in batches of $15$ and interleave the count-3s and count-5s.  An
example of this is included in the github repo.
...
meant to be hard, it's meant to be a minimum evaluation function.
...
post if necessary) and maybe get a pass on the interview question.
